...
YOUTUBE_TASKS = AppTasks(
    ...
    task_items=[
        ...
        TaskItem(
            instruction="给Jay Chou的青花瓷评论“这首歌太动听了”",
            verify_func=validate_task_eight,
            human_steps=8,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="在历史记录页面查看我一共看了几条Jay Chou的mv",
        ...
        TaskItem(
            instruction="Jay Chou夜曲的MV中，最新的评论的点赞数是多少？",
        ...
        TaskItem(
            instruction="播放Jay Chou的夜曲，品质选择Higher picture quality，打开Loop video和Stable volume",
            verify_func=validate_task_thirty_one,
            human_steps=12,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="播放Jay Chou的青花瓷，品质选择Higher picture quality，关闭Ambient mode",
            verify_func=validate_task_thirty_two,
            human_steps=11,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="先在quality页面打开Higher picture quality，再播放Jay Chou的青花瓷，并评论“这个MV真清晰”",
            verify_func=validate_task_thirty_three,
            human_steps=16,
            is_reasoning=False,
        ),
        TaskItem(
            instruction="给Jay Chou的夜曲点赞加收藏并评论“我是周杰伦十年老粉”，再给青花瓷点赞加收藏并评论“这首歌让我想起了那个女孩”",
